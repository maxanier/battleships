...
public abstract class Server {
	 ...
	 * 
	 * @param pClientIP
	 *            IP-Nummer des Clients der gesuchten Verbindung
	 * @param pClientPort
	 *            Port-Nummer des Clients der gesuchten Verbindung
	 */
	 ...
	 * 
	 * @param pClientIP
	 *            IP-Nummer des Clients der zu beendenden Verbindung
	 * @param pClientPort
	 *            Port-Nummer des Clients der zu beendenden Verbindung
	 */
	public void closeConnection(String pClientIP, int pClientPort) {
		...
		if (lSerververbindung != null) {
			...
			System.err.println("Fehler beim Schlie\u00DFen der Verbindung: IP " + pClientIP + " mit Port "
					+ pClientPort + " nicht vorhanden.");
	 ...
	 * 
	 * @param pVerbindung
	 *            die zu l&ouml;schende Verbindung
	 */
