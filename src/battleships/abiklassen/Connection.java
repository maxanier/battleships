 ...
 * </p>
 * <p>
 * Objekte der Klasse Connection ermöglichen eine Netzwerkverbindung mit dem TCP/IP-Protokoll. Es können nach Verbindungsaufbau zu
 * einem Server Zeichenketten (Strings) gesendet und empfangen werden. Zur Vereinfachung geschieht dies zeilenweise, d. h., beim
 * Senden einer Zeichenkette wird ein Zeilentrenner ergänzt und beim Empfangen wird er entfernt.
 * </p>
 * 
 * <p>
...
public class Connection extends Thread {
	...
	/**
	 * Es wird eine Verbindung zum durch IP-Adresse und Portnummer angegebenen Server aufgebaut, so dass Daten gesendet und
	...
	/**
	 * Es wird auf eine eingehende Nachricht vom Server gewartet und diese Nachricht zurückgegeben, wobei der vom Server
	 * angehängte Zeilentrenner entfernt wird. Während des Wartens ist der ausführende Prozess blockiert.
	 */
