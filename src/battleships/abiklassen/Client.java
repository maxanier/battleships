...
public abstract class Client {
	...
	class Clientempfaenger extends Thread {
		 ...
		 * 
		 * @param pClient
		 *            zugeh&ouml;riger Client, der die einkommenden Nachrichten bearbeitet
		 * @param pConnection
		 *            zugeh&ouml;rige Connection, die die einkommenden Nachrichten empfängt
		 */
	 ...
	 * 
	 * @param pIPAdresse
	 *            IP-Adresse bzw. Domain des Servers
	 * @param pPortNr
